  ...
  capabilities: {
    ...
    content: (
      <ul className={styles.modalList}>
        ...
        <li>Возвращает таблицу результата, краткую аналитическую интерпретацию и простую визуализацию.</li>
    ...
    content: (
      <div className={styles.modalText}>
        <Typography.Paragraph>
          Модуль работает с агрегированными данными OLAP-куба и промежуточными артефактами пайплайна: сформированным
          DAX-запросом, строками ответа и технической диагностикой.
        </Typography.Paragraph>
        <Typography.Paragraph>
          В интерфейсе вы видите только необходимые для анализа сущности: результирующую таблицу, краткий вывод модели,
          базовый график и служебный статус выполнения.
        </Typography.Paragraph>
      </div>
    ),
  },
  limits: {
    ...
    content: (
      <ul className={styles.modalList}>
        ...
        <li>Сервис не заменяет проверку KPI аналитиком и должен использоваться как инструмент ускорения.</li>
        <li>При больших выборках отображается сокращенный набор агрегированных строк (демо-ограничение).</li>
...
export function ServiceInfo() {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <Modal title={selectedSection?.title} open={Boolean(selectedSection)} onCancel={handleClose} footer={null}>
